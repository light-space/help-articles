...
You'll need:
- Administrator access to Light (only company admins can add bank accounts and bank connections)
...
Light supports the following connection methods:

**Plaid** - Covers most banks in the United States. Fastest setup for consumer and business accounts.
...
Plaid connects to thousands of banks in the United States. This is the recommended method for US bank accounts.
...
6. You'll be directed to your bank's login page (secure, not through Light)
7. Enter your banking credentials and approve the connection
8. Select which accounts to connect to Light (you can connect multiple)
9. Verify the account details and click **Connect**
...
2. Enter:
   ...
   - **Bank details** - IBAN, BIC, or domestic account number and bank code
...
- Check that the bank connection status shows "Linked" (not "Expired")
- Some banks take 24 hours to provide the first transaction feed
- If it's been longer than 24 hours, renew the bank connection
