...
### Large exports (ledger transactions)

If you're exporting a large number of ledger transactions, Light may prepare the file in the background instead of downloading it immediately. When this happens:
