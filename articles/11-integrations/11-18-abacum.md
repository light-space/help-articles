...
How the Abacum connection is set up, which Light data reaches Abacum, and how often it refreshes. Light's team handles the Light side; the steps you carry out yourself happen in Abacum.

**Setting up your Light connection**

1. Contact your Light representative to request data sharing with Abacum.
2. Light's engineering team provisions a dedicated S3 bucket and credentials for your company and configures which data exports to it. Both are manual, so allow time.
...
**Excluded postings** (transaction lines only)
